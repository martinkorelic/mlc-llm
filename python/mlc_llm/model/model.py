...
from .llamalora import llama_model as llamalora_model, llama_loader as llamalora_loader, llama_quantization as llamalora_quantization
...
MODELS: Dict[str, Model] = {
    "llamalora": Model(
        ...
        quantize={
            "no-quant": llamalora_quantization.no_quant,
        },
    ),
    "llama": Model(
        name="llama",
